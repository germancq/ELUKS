...
set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33 } [get_ports { leds[2] }]; #IO_L22P_T3_A05_D21_14 Sch=led[10]
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { leds[3] }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 Sch=led[11]
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33 } [get_ports { leds[4] }]; #IO_L16P_T2_CSI_B_14 Sch=led[12]
set_property -dict { PACKAGE_PIN V14   IOSTANDARD LVCMOS33 } [get_ports { leds[5] }]; #IO_L22N_T3_A04_D20_14 Sch=led[13]
...
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets wb_e_luks_inst/e_luks_inst/fsm/r_block_prev_reg_0];
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets wb_e_luks_inst/e_luks_inst/fsm/r_state_prev/r_block_prev_reg_0];
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets wb_e_luks_inst/e_luks_inst/fsm/r_state_prev/luks_r_block];
