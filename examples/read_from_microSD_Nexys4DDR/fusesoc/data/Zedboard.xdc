...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y9 [get_ports {sys_clk_pad_i}];  # "GCLK"

# ----------------------------------------------------------------------------
# JA Pmod - Bank 13  used as SPI interface
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y11  [get_ports {sclk}];  # "JA1"
set_property PACKAGE_PIN AA8  [get_ports {mosi}];  # "JA10"
set_property PACKAGE_PIN AA11 [get_ports {miso}];  # "JA2"
set_property PACKAGE_PIN Y10  [get_ports {cs}];  # "JA3"
set_property PACKAGE_PIN AA9  [get_ports {SD_RESET}];  # "JA4"
set_property PACKAGE_PIN AB11 [get_ports {SD_DAT_1}];  # "JA7"
set_property PACKAGE_PIN AB10 [get_ports {SD_DAT_2}];  # "JA8"
...
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets eluks_inst/fsm/r_block_prev_i_3_n_0];